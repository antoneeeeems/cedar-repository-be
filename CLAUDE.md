...
Standalone Express.js + TypeScript API for CEDAR.
...
Explain code with visual diagrams and clear mental models
...
Emergency production fix — create hotfix branch, minimal change, critical tests only, ship fast
...
Scan the project codebase and customize all .claude/ configuration files to match. Run this after adding the .claude/ folder to a new project.

- `.claude/skills/setupdotclaude/SKILL.md`
